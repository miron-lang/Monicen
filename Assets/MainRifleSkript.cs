...
public class MainRifleSkript : MonoBehaviour
{
    public Animator anim;

    public float nextTimeToShoot = 1.5f;
    ...
    void Update()
    {
        ...
        if (isAutomaticFire ? Input.GetKey(KeyCode.Mouse0) : Input.GetKeyDown(KeyCode.Mouse0))
        {
